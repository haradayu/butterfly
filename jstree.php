...
if(isset($_POST['operation_post'])){
    if($_POST['operation_post'] === 'save_content'){
        ...
        // echo $dir . DIRECTORY_SEPARATOR . $_POST['filename'];
        $node = isset($_POST['parent']) && $_POST['parent'] !== '#' ? $_POST['parent'] : '/';
        $rslt = $fs->save_content($node, isset($_POST['filename']) ? $_POST['filename'] : '', isset($_POST['content']) ? $_POST['content'] : '');
    }
